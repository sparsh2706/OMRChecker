...
Answers={
	...
	'HK':{
		'q1': ['D'],'q2':['A'],'q3':['C'],'q4': ['D'],'q5': ['A'],'q6': ['13'],'q7': ['0'],
		'q8': ['2','02'],    'q9': ['0'],'q10': ['C'],'q11': ['A'],'q12': ['BONUS'],'q13': ['B'],
	'q14': ['B','GODPOWER'],'q15': ['A','C'],'q16': ['A','B'],'q17': ['B'],'q18': ['A','D'],'q19': ['30'],'q20': ['31'],'q21' : ['21'],'q22' : ['4','04','GOD']},
	}
...
Sections = {
	...
	'H':{
		...
		'Power1':{'ques':[10,11,12,13,14],'+seq':[1,2,4,8,16],'-seq':[0,0,0,0,0]},
		'allNone1':{'ques':[15,16,17,18],'marks':12},
		'Proxy2':{'ques':[19,20,21,22],'marks':[3,1,-1]}
	},
}
# 1 3 9 27
# 1 => 1 
